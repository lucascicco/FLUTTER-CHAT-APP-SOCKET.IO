import 'dart:convert';
import '../../viewmodel/chat/chat_view_model.dart';
import '../../views/chat/hero_image.dart';
                ...
                onTap: () => Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => HeroImage(
                            imageProvider:
                                MemoryImage(base64Decode(message.content))))),
                child: Container(
                  decoration: BoxDecoration(
                      color:
                          message.isMy ? Color(0xFF1289FD) : Color(0xFFE5E4EA),
